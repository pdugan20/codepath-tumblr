...
class ComposeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Animate textButton
        UIView.animateWithDuration(0.5, delay: 0.05, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.6, options: nil, animations: { () -> Void in
        ...
        // Animate linkButton
        UIView.animateWithDuration(0.5, delay: 0.2, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.6, options: nil, animations: { () -> Void in
        ...
        // Animate videoButton
        UIView.animateWithDuration(0.5, delay: 0.25, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.6, options: nil, animations: { () -> Void in
    ...
    @IBAction func didPressNevermindButton(sender: AnyObject) {
        ...
        // Animate textButton
        UIView.animateWithDuration(0.5, delay: 0.05, usingSpringWithDamping: 1, initialSpringVelocity: 0, options: nil, animations: { () -> Void in
        ...
        // Animate linkButton
        UIView.animateWithDuration(0.5, delay: 0.2, usingSpringWithDamping: 1, initialSpringVelocity: 0, options: nil, animations: { () -> Void in
            self.linkButton.center.y = -75
            }) { (Bool) -> Void in
                // Do something
        }
        // Animate chatButton
        UIView.animateWithDuration(0.5, delay: 0.15, usingSpringWithDamping: 1, initialSpringVelocity: 0, options: nil, animations: { () -> Void in
            self.chatButton.center.y = -75
            }) { (Bool) -> Void in
                // Do something
        }
        // Animate videoButton
        UIView.animateWithDuration(0.5, delay: 0.25, usingSpringWithDamping: 1, initialSpringVelocity: 0, options: nil, animations: { () -> Void in
